...
from worker_supplier_outbox.features.publish_outbox.message_publisher import (
    MessagePublisher,
)
from worker_supplier_outbox.features.publish_outbox.result import (
    PublishOutboxResult,
)
...
from worker_supplier_outbox.shared.unit_of_work import (
    OutboxUnitOfWork,
)
        ...
        for message in messages:
            ...
            try:
                with start_producer_span(
                    tracer,
                    "sqs.publish supplier.sap-sync.requested",
                ) as span:
                    span.set_attribute(
                        "messaging.system",
                        "aws.sqs",
